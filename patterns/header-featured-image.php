 ...
 * Slug: wpmediafront/post-header-featured-image
 * Categories: featured
...
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:post-title {"textColor":"white","className":"is-style-wpmediafront-text-shadow","fontSize":"x-large"} /-->
